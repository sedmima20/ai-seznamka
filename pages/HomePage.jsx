    ...
    return (
        <>
            <section>
                ...
                <p>
                    Už Vás nebaví nekonečně dlouhé prohledávání seznamovacích inzerátů na všech možných seznamkách, které
                    ...
                    inzerát, tak ho najdou Vaši přátelé? Bojíte se, že narazíte na spoustu falešných účtů?
                </p>
                <p>
                    <b>Tomu všemu je konec!</b> Jsem Zuzana, umělá inteligence, která rozumí seznamování, a pomohu Vám
            ...
            <section>
                ...
                <ol>
                    <li>
                        <h3>Vložíte svůj seznamovací inzerát přes formulář</h3>
                        <br/>
                        ...
                        <br/>
                        <strong>
                            Více informací sice znamená méně matchů, ale nalezení lidé budou mnohem
                    ...
                    <li>
                        <h3>Zuzana následně začne porovnávat inzeráty a vyhodnocovat, s kým se k sobě hodíte a s kým ne</h3>
                        <br/>
                        Vyzkouší různé kombinace uživatelů a pro každou otestuje kompatibilitu. Zjistí, zda
                        se shodují Vaše požadavky s tím, jaká druhá osoba je a co hledá, a naopak.
                    </li>
                    <li>
                        <h3>Jakmile Zuzana nalezne potenciální shodu, pošle Vám e-mail</h3>
                        <br/>
                        Vlastními slovy Vám v jednoduchosti popíše, jaký druhý člověk je a co by se Vám na něm mohlo líbit.
                        Také doporučí, o čem byste mohli navázat komunikaci, aby seznamování bylo příjemnější. Zuzana se ale také nebude
                        bát případně doplnit věci, ve kterých byste s druhým člověkem kompatibilní být nemuseli. Zároveň
                        však nikdy neprozradí více, než je nutné, a neukáže Vám konkrétní znění inzerátu.
                        <br/>
                        <strong>
                            Buďte trpěliví. Hledání vhodného protějšku může nějakou chvíli trvat, takže e-mail nemusí dorazit
            ...
            <section>
                ...
                <div className="card-container">
                    <div>
                        <h3>1. Soukromnější už to být nemůže</h3>
                        <br/>
            ...
            <section>
                ...
                <ul>
                    <li>
                        <h3>Uveďte co nejpodrobněji, kdo jste a koho hledáte</h3>
                        <br/>
                        Jste muž, žena nebo někdo jiný?
                        ...
                        <br/>
                        <strong>
                            Rozhodně nemusíte použít vše z tohoto seznamu, ale hodně doporučujeme si
                            všechny body alespoň jednou v hlavě projít a nevynechat nic, na čem by Vám mohlo
                            záležet.
                        </strong>
                    </li>
                    <li>
                        <h3>Píšete to pro umělou inteligenci, ne pro lidi</h3>
                        <br/>
                        Nikomu nebude vadit, že je inzerát dlouhý a je že v něm hodně informací, protože ho nikdo živý
                        číst nebude! AI to nevadí, ta to zvládne hned, a delší, konkrétnější texty dokonce ocení víc,
                        protože si o Vás a o tom, co a koho hledáte, bude moct udělat přesnější představu.
                    </li>
                </ul>
            </section>
            <section>
